          ...
          >
            <span class="inline-flex rounded-md shadow">
              <nuxt-link
                v-if="!isLoggedIn"
                to="/login"
                class="inline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-pink-600 bg-white hover:text-pink-500 focus:outline-none focus:shadow-outline-blue active:bg-gray-50 active:text-pink-700 transition duration-150 ease-in-out"
              >Log in</nuxt-link>
              <nuxt-link
                v-else
                to="/profile"
          ...
          <div class="rounded-lg shadow-md">
            <div class="rounded-lg bg-white shadow-xs overflow-hidden">
              ...
              <div>
                <a
                  href="#"
                  class="block w-full px-5 py-3 text-center font-medium text-pink-600 bg-gray-50 hover:bg-gray-100 hover:text-pink-700 focus:outline-none focus:bg-gray-100 focus:text-pink-700 transition duration-150 ease-in-out"
                >Log in</a>
              </div>
            </div>
          </div>
      ...
      <div class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
        <div class="text-center">
          ...
          >
            Game
            <br class="xl:hidden" />
            <span class="text-pink-600">Friendly</span>
          </h2>
          <p
          ...
          <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
            ...
            <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
              <a
                href="#"
                class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-pink-600 bg-white hover:text-pink-500 focus:outline-none focus:shadow-outline-blue transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10"
              >Live demo</a>
            </div>
          </div>
        </div>
